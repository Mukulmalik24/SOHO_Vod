 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "df_3.to_csv(\"C:\\\\Users\\\\MalikM\\\\Documents\\\\CVM TEAM -PUNE\\\\UK\\\\OUTPUT\\\\train_aspect_sentiment_SOHOcare_May.csv\")"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "df_test2['sentiment']=np.where(df_test2['polarity']==0,'Neutral',np.where(df_test2['polarity']>0,'Positive','Negative'))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "df_test2.to_csv(\"C:\\\\Users\\\\MalikM\\\\Documents\\\\CVM TEAM -PUNE\\\\UK\\\\OUTPUT\\\\test_aspect_sentiment_SOHOcare_May.csv\")"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "### for words frequency ####\n",
    "# df_3.to_csv( \"C:\\\\Users\\\\MalikM\\\\Documents\\\\CVM TEAM -PUNE\\\\UK\\\\CARE COMBINED\\\\OUTPUT_Care_combined_train_sentiment.csv\" )"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "result_df_CustService.to_csv(\"C:\\\\Users\\\\MalikM\\\\Documents\\\\CVM TEAM -PUNE\\\\UK\\\\CARE COMBINED\\\\input_for_topic_modelling_CustServe.csv\")"
   ]
  },
  {
   "cell_type": "code",
